...
//adapter
    ...
    //biến  cu lệnh tạo bảng tài khoản
   ...
   // phân quyền tài khoản
    ...
    public databasedoctruyen(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
